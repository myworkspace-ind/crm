document.addEventListener('DOMContentLoaded', function() {
	...
	searchButton.addEventListener('click', function() {
		...
		const requestUrl = `${_ctx}orders-vinh/search-orders-list?${params}`;

		console.log("Request URL:", requestUrl);

		fetch(`${_ctx}orders-vinh/search-orders-list?${params}`, {
			method: 'GET',
			headers: {
	...
	function loadCustomerInfo(customerId, phone, name) {
		fetch(`${_ctx}orders-vinh/get-sender-receiver-details?customerId=${customerId}`)
