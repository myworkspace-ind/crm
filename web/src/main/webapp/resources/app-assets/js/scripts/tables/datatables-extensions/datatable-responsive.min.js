$(document).ready(function () {
    ...
    var e = $(".dataex-res-constructor").DataTable();
    new $.fn.dataTable.Responsive(e);
        ...
        responsive: {
            details: {
                ...
                renderer: function (e, a, t) {
                    var r = $.map(t, function (e, a) {
                        return "<tr><td>" + e.title + ":</td> <td>" + e.data + "</td></tr>";
                    }).join("");
    ...
    var a = $(".dataex-res-fixedheader").DataTable({
        responsive: !0
    });
    ...
    $(".dataex-res-scrolling").DataTable({
        scrollY: 300,
        paging: !1
    });
