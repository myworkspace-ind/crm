...
public class ProfessionValidator {
	public static List<Profession> validateAndCleasing(List<Object[]> data) {
		List<Profession> paramList = new ArrayList<>();
		...
		for (Object[] rowData : data) {
			if (CommonUtil.isNNNE(rowData)) {
				...
				Profession responsiblePerson = new Profession(responsiblePersonId, 
